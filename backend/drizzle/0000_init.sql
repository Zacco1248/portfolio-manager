...
CREATE TABLE `realized_gains` (
	...
	`tax_cost_pln_minor` integer DEFAULT 0 NOT NULL,
	`tax_proceeds_pln_minor` integer DEFAULT 0 NOT NULL,
	`tax_gain_pln_minor` integer DEFAULT 0 NOT NULL,
	`year` integer NOT NULL,
...
CREATE TABLE `transactions` (
	...
	`fx_date` text,
	`settlement_fx_rate_e6` integer,
	`amount_pln_minor` integer DEFAULT 0 NOT NULL,
	`tax_amount_pln_minor` integer DEFAULT 0 NOT NULL,
	`note` text,
